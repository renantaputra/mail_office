(function(){
	var theViewer=window.theViewer=window.theViewer||{
	}
	,CSS_CLASS_NAMES={
	...
	function disable_dragstart(a){
		...
		b<c;
		++b)a[b].addEventListener("dragstart",function(){
			return!1
}
		,!1)
}
	...
	Viewer.prototype={
		...
		,initialize_radio_button:function(){
			for(var a=document.getElementsByClassName(CSS_CLASS_NAMES.input_radio),b=0;
			b<a.length;
		...
		,init_after_loading_content:function(){
			...
			for(var a=!0,b=this.outline.childNodes,c=0,e=b.length;
			c<e;
			++c)if("ul"===b[c].nodeName.toLowerCase()){
				a=!1;
				break
}
		...
		,find_pages:function(){
			...
			,c=this.container.childNodes,e=0,h=c.length;
			e<h;
			++e){
				var d=c[e];
				...
				if(h){
					...
					g.onload=function(){
						if(200===g.status||0===g.status){
							...
							for(var d=null,b=b.childNodes,e=0,h=b.length;
							e<h;
							++e){
								var p=b[e];
		...
		,render:function(){
			for(var a=this.container,b=a.scrollTop,c=a.clientHeight,a=b-c,b=b+c+c,c=this.pages,e=0,h=c.length;
			e<h;
			++e){
		...
		,update_page_idx:function(){
			...
			if(!(2>b)){
				for(var c=this.container,e=c.scrollTop,c=e+c.clientHeight,h=-1,d=b,f=d-h;
				1<f;
				){
				...
				for(var g=h=this.cur_page_idx,k=0;
				d<b;
				++d){
		...
		,register_key_handler:function(){
			...
			window.addEventListener("keydown",function(b){
				...
				switch(b.keyCode){
					case 61:case 107:case 187:e&&(a.rescale(1/a.config.scale_step,!0),c=!0);
					break;
					case 173:case 109:case 189:e&&(a.rescale(a.config.scale_step,!0),c=!0);
					break;
					case 48:e&&(a.rescale(0,!1),c=!0);
					break;
					case 33:h?a.scroll_to(a.cur_page_idx-1):a.container.scrollTop-=a.container.clientHeight;
					c=!0;
					break;
					case 34:h?a.scroll_to(a.cur_page_idx+1):a.container.scrollTop+=a.container.clientHeight;
					c=!0;
					break;
					case 35:a.container.scrollTop=a.container.scrollHeight;
					c=!0;
					break;
					case 36:a.container.scrollTop=0,c=!0
}
				c&&b.preventDefault()
}
			,!1)
		...
		,rescale:function(a,b,c){
			...
			c[0]+=b.scrollLeft;
			c[1]+=b.scrollTop;
			for(var h=this.pages,d=h.length,f=this.first_page_idx;
			f<d;
			++f){
				var g=h[f].page;
		...
		,navigate_to_dest:function(a,b){
			...
			if(c instanceof Array){
				...
				if(h in d){
					for(var f=d[h],h=this.pages[f],d=2,g=c.length;
					d<g;
					++d){
						var k=c[d];
					...
					var g=b||this.pages[this.cur_page_idx],d=g.view_position(),d=transform(g.ictm,[d[0],g.height()-d[1]]),g=this.scale,l=[0,0],m=!0,k=!1,n=this.scale;
					switch(c[1]){
						case "XYZ":l=[null===c[2]?d[0]:c[2]*n,null===c[3]?d[1]:c[3]*n];
						g=c[4];
						if(null===g||0===g)g=this.scale;
						k=!0;
						break;
						case "Fit":case "FitB":l=[0,0];
						k=!0;
						break;
						case "FitH":case "FitBH":l=[0,null===c[2]?d[1]:c[2]*n];
						k=!0;
						break;
						case "FitV":case "FitBV":l=[null===c[2]?d[0]:c[2]*n,0];
						k=!0;
						break;
						case "FitR":l=[c[2]*n,c[5]*n],m=!1,k=!0
}
					if(k){
						this.rescale(g,!1);
