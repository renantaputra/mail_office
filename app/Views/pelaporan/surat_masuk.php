    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="<?php echo base_url('suratMasuk/laporan'); ?>" method="POST" class="form-inline">
                    ...
                    <button type="submit" name="button_go" class="btn btn-primary mb-2">Go</button>
                </form>
            </div>
        </div>
    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                Laporan Surat Masuk Tanggal <strong><?= $tgl_awal; ?> sampai <?= $tgl_akhir; ?></strong>
                                <form action="<?php echo base_url('suratMasuk/exportPDF'); ?>" method="POST" class="form-inline float-right">
